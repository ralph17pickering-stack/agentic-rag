...
**File:** `backend/app/services/hashing.py` (new)
...
| `backend/app/services/hashing.py` | New file |
| `backend/app/services/chunker.py` | Add content_hash to Chunk |
| `backend/app/models/documents.py` | Add content_hash, is_duplicate |
| `backend/app/routers/documents.py` | Dedup logic in upload |
| `backend/app/services/ingestion.py` | Store chunk hashes, existence check |
| `frontend/src/types/index.ts` | Add new fields |
| `frontend/src/hooks/useDocuments.ts` | Handle duplicate response |
| `frontend/src/components/documents/DocumentsPanel.tsx` | Info banner |
