...
| `backend/app/services/metadata.py` | New — LLM extraction service |
| `backend/app/services/ingestion.py` | Call extract_metadata, store results |
| `backend/app/models/documents.py` | Add title, summary, topics, document_date |
| `backend/app/services/retrieval.py` | Pass date/recency params to RPC |
| `backend/app/services/llm.py` | Tool params, context format, RetrieveFn type |
| `backend/app/routers/chat.py` | Forward kwargs in retrieve_fn closure |
| `frontend/src/types/index.ts` | Add metadata fields |
| `frontend/src/components/documents/DocumentsPanel.tsx` | Display metadata |
