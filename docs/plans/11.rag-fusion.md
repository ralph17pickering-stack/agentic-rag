...
| File | Action |
|---|---|
| `app/backapp/frontend/app/config.py` | Add 2 config flags |
| `app/backapp/frontend/app/services/query_expansion.py` | **Create** — sub-query generation |
| `app/backapp/frontend/app/services/retrieval.py` | Refactor `retrieve_chunks` |
| `.agent/plans/11.rag-fusion.md` | Save plan copy per project convention |

## Step-by-Step Plan

### 1. `app/backapp/frontend/app/config.py` — Add flags
...
### 2. Create `app/backapp/frontend/app/services/query_expansion.py`
...
### 3. `app/backapp/frontend/app/services/retrieval.py` — Refactor `retrieve_chunks`
