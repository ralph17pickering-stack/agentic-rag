...
- Add a new route in `app/backapp/frontend/routers/threads.py` (or wherever thread routes live)
...
- Backend threads router: `app/backapp/frontend/routers/threads.py`
- Frontend hooks: `app/frontend/src/hooks/`
- Frontend chat layout: `app/frontend/src/components/ChatLayout.tsx` or similar
